...
export default function CambiarContraseña({ navigation }) {
  ...
  const changeDevicePassword = async (password, newPassword) => {
    ...
    const peticion = await axios
      .put(
        "https://proyecto-backend-movil-production.up.railway.app/app_movil_sensor/api/device/change-device-password",
        notification,
        headers
      )
      .then(async (res) => {
        console.log("confirmacion contraseña");
        navigation.navigate("PantallaCodigoCambiarContraseñaDisp", {
