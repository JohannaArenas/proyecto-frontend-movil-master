...
export default function VerHistorial({ navigation }) {
  ...
  const VerHistorial = async () => {
    ...
    const peticion = await axios.get("https://proyecto-backend-movil-production.up.railway.app/app_movil_sensor/api/device/" + codeDisp + "/history", headers)
      .then(async res => {
   ...
   const BorrarHistorial = async () => {
    ...
    const token = await AsyncStorage.getItem('@storage_Key');
     ...
     const peticion = await axios.delete("https://proyecto-backend-movil-production.up.railway.app/app_movil_sensor/api/device/"+codeDisp+"/clear-history", headers)
       .then(async res => {
